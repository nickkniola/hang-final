...
export default class ConfirmSelection extends React.Component {
  constructor(props) {
    super(props);
      ...
      <>
        <div className="ui card centered">
          ...
          <div className="content">
            <div className="header">Sports with Another User</div>
            <div className="description">
              Play basketball at Sports Center with Another User on Jul 10/3/2021 at 1PM.
            </div>
          </div>
